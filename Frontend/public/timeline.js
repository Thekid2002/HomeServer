        ...
        .then(files => {
            ...
            files.forEach(file => {
                ...
                fileElement.addEventListener('dragstart', (e) => {
                    ...
                    startColumn = [...draggingVideoClip.parentElement.children].indexOf(draggingVideoClip);
...
function setupAudioClipEventListener() {
    ...
    audioClips.forEach(clip => {
        clip.addEventListener('dragstart', (e) => {
            ...
            startColumn = [...draggingAudioClip.parentElement.children].indexOf(draggingAudioClip);
    ...
    audioTimeLineContainer.addEventListener('dragover', (e) => {
        ...
        const afterElement = audioGetDragAfterElement(audioTimeLineContainer, e.clientX);
...
function setupVideoClipEventListener() {
    ...
    videoTimeLineContainer.addEventListener('dragover', (e) => {
        ...
        const afterElement = videoGetDragAfterElement(videoTimeLineContainer, e.clientX);
        const dragging = document.querySelector('.dragging');
        if (afterElement == null) {
