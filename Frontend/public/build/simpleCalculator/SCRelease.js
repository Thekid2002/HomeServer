    ...
    const adaptedExports = Object.setPrototypeOf(
        {
            calculateViaLanguage(string) {
                // assembly/Index/calculateViaLanguage(~lib/string/String) => ~lib/string/String
...
export const { memory, calculateViaLanguage } = await (async (url) =>
    instantiate(
        await (async () => {
            const isNodeOrBun =
        ...
        {}
    ))(new URL("SCRelease.wasm", import.meta.url));
