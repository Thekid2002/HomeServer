...
export class ParseTreePrinter implements ParseVisitor<void> {
    ...
    visitAssignment(statement: ParseAssignment): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": ParseAssignment"
        );
        this.number++;
    ...
    visitIncrement(statement: ParseIncrement): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": ParseIncrement"
        );
        this.number++;
        statement.identifier.accept<void>(this);
        this.number--;
    ...
    visitFunction(statement: ParseFunctionDeclaration): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": FunctionObject"
        );
        this.number++;
    ...
    visitLoopStatement(statement: ParseLoopStatement): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": While"
        );
        this.number++;
    ...
    visitProgram(statement: ParseProgram): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": ParseProgram"
        );
        this.number++;
        if (statement.body !== null) {
      statement.body!.accept<void>(this);
    ...
    visitReturn(statement: ParseReturn): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": ParseReturn"
        );
        this.number++;
        statement.expression.accept<void>(this);
        this.number--;
    ...
    visitImport(statement: ParseImport): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": ParseImport"
        );
        this.number++;
    ...
    visitIfStatement(statement: ParseIfStatement): void {
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": If"
        );
        this.number++;
        statement.condition.accept<void>(this);
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": Then"
        );
        this.number++;
        if (statement.body !== null) {
      statement.body!.accept<void>(this);
        ...
        this.number--;
        this.tree.push(
            this.getSpace(this.number) + this.number.toString() + ": Else"
        );
        this.number++;
