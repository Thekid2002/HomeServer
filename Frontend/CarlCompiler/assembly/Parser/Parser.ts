...
export class Parser {
    ...
    private program(): Program | null {
        ...
        return new Program(statements, statements[0].lineNum);
    }
    ...
    private while(): LoopStatement | null {
        ...
        if(this.match([TokenType.LEFT_BRACE])) {
            ...
            return new LoopStatement(null, expression, statements, expression.lineNum);
        }
        this.errors.push("Expected '{' at line: " + this.peek().line.toString());
        return null;
    }
    ...
    private for(): LoopStatement | null {
        ...
        if(this.match([TokenType.LEFT_BRACE])) {
            ...
            return new LoopStatement(declaration, expression, statements, expression.lineNum);
        }
        this.errors.push("Expected '{' at line: " + this.peek().line.toString());
        return null;
    }
