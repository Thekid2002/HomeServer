...
export class While extends AbstractStatement {
    ...
    constructor(initiator: AbstractStatement | null, condition: AbstractExpression, body: AbstractStatement | null, lineNum: i32) {
        super(lineNum);
    ...
    toString(): string {
        return "While(" + (this.initiator !== null ? this.initiator!.toString() : "null") + ", " + this.condition.toString() + ", " + (this.body !== null ? this.body!.toString() : "null") + ")";
    }
}
